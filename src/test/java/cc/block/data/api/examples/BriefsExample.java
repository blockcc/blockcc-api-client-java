 ...
 * @author lijiaxing
 * @date 2020/10/20
 * @see BlockccApiRestClient#getBriefs(BriefParam) (cc.block.api.client.aomain.market.request.BriefParams)
 * All Briefs channel examples.
 * It illustrates how to create a stream to obtain all Briefs.
 */
public class BriefsExample {
    public static void main(String[] args) {
        ...
        BriefParam briefParams = BriefParam.builder().locale(Locale.CHINA).size(1).build();
        for (Brief brief : client.getBriefs(briefParams).getContent()) {
